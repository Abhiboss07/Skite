                  ...
                  <Command.List className="max-h-[min(24rem,50vh)] overflow-y-auto overscroll-contain p-2">
                    ...
                    {grouped.map(({ group, items }) => (
                      <Command.Group
                        key={group}
                        heading={group}
                        className="mb-1 [&_[cmdk-group-heading]]:px-3 [&_[cmdk-group-heading]]:py-2 [&_[cmdk-group-heading]]:font-mono [&_[cmdk-group-heading]]:text-[10px] [&_[cmdk-group-heading]]:tracking-[0.16em] [&_[cmdk-group-heading]]:text-subtle [&_[cmdk-group-heading]]:uppercase"
                      >
                        {items.map((route) => (
                          <CommandRow
                            key={route.href}
